...
public class NudgeTelescopeBackwardsCommand extends EntechCommandBase {
   ...
   */
  public NudgeTelescopeBackwardsCommand(ArmSubsystem subsystem, boolean waitToComplete) {
      super(subsystem);
