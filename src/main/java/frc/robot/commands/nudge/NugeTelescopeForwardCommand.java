...
public class NugeTelescopeForwardCommand extends EntechCommandBase {
   ...
   */
  public NugeTelescopeForwardCommand(ArmSubsystem subsystem, int requestedPosition, boolean waitToComplete, PositionController positionController) {
      super(subsystem);
